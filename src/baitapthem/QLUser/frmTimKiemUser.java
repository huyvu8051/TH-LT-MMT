...
public class frmTimKiemUser extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        buttonGroup1.add(rbRead);
        buttonGroup1.add(rbWrite);
        ...
        btnTimKiemtheoten.setBackground(new java.awt.Color(255, 255, 255));
        ...
        btnTimKiemtheoquyen.setBackground(new java.awt.Color(255, 255, 255));
        ...
        btn_dsnguoisd.setBackground(new java.awt.Color(255, 255, 255));
...
//        this.validate();
        ...
        ResultSet rs = acc.Query("SELECT * FROM thongtinnguoisd WHERE Ten LIKE '%" + ten + "%'");
        DefaultTableModel dm = (DefaultTableModel) this.tblKetQua.getModel();
        dm.setRowCount(0);
