 ...
 * @author huyvu
 */
public class TimIPTenMienFrame extends javax.swing.JFrame {

    /**
     * Creates new form TimIPTenMien
     */
    public TimIPTenMienFrame() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            int i, j;
            InetAddress addr[] = InetAddress.getAllByName(txtDomain.getText());
            ...
            JOptionPane.showMessageDialog(null, "Dia chi cua ban nhap sai!");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TimIPTenMienFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TimIPTenMienFrame().setVisible(true);
            }
        });
    }
